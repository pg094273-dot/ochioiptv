class IPTVApp {
    ...
    renderContent(items) {
        ...
        if (items.length > max) {
            ...
            more.textContent = `Mostrando ${max} de ${items.length}. Usa búsqueda para encontrar más.`;
    ...
    async selectContent(content, element) {
        ...
        // Verificar si tiene posición guardada
    ...
    async playSelected() {
        ...
        try {
            ...
            alert('Error al reproducir:\n' + error.message + '\n\nPrueba con otro canal/contenido.');
        }
    }
